...
## Vídeos: copiar e colar link (editar itens já existentes)
Na aba **Banco**, cada item agora tem:
- **Copiar link** (quando existe `youtubeId`)
- **Definir vídeo / Editar vídeo**: cole um link do YouTube ou um ID (11 caracteres). Para remover, deixe vazio.

Isso é salvo como *override* no aparelho (localStorage) e também vai junto no **Exportar/Importar**.
